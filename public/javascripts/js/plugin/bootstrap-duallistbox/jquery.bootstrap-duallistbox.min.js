!function (a, b, c, d) {
    ...
    var v = "bootstrapDualListbox", w = {
        ...
        "filterTextClear": "전체 보기",
        "filterPlaceHolder": "필터링 문자",
        "moveSelectedLabel": "선택한 빈소 추가하기",
        "moveAllLabel": "전체 빈소 추가하기",
        "removeSelectedLabel": "선택한 빈소 제거하기",
        "removeAllLabel": "전체 빈소 제거하기",
        "moveOnSelect": !0,
        ...
        "selectedFilter": "",
        "infoText": "전체 리스트 : {0}",
        "infoTextFiltered": '<span class="label label-warning">필터링</span> {0} / {1}',
        "infoTextEmpty": "리스트가 비어있음",
        "filterOnValues": !1,
        "sortByInputOrder": !1
    ...
    e.prototype = {
        "init": function () {
            ...
            return this.settings.bootstrap2Compatible = a, a ? (this.container.removeClass("row").addClass("row-fluid bs2compatible"), this.container.find(".box1, .box2").removeClass("col-md-12").addClass("span6"), this.container.find(".clear1, .clear2").removeClass("btn-default btn-xs").addClass("btn-mini"), this.container.find("input, select").removeClass("form-control"), this.container.find(".btn").removeClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("glyphicon glyphicon-arrow-right").addClass("icon-arrow-right"), this.container.find(".removeall > i, .remove > i").removeClass("glyphicon glyphicon-arrow-left").addClass("icon-arrow-left")) : (this.container.removeClass("row-fluid bs2compatible").addClass("row"), this.container.find(".box1, .box2").removeClass("span6").addClass("col-md-12"), this.container.find(".clear1, .clear2").removeClass("btn-mini").addClass("btn-default btn-xs"), this.container.find("input, select").addClass("form-control"), this.container.find(".btn").addClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("icon-arrow-right").addClass("glyphicon glyphicon-arrow-right"), this.container.find(".removeall > i, .remove > i").removeClass("icon-arrow-left").addClass("glyphicon glyphicon-arrow-left")), b && k(this), this.element
